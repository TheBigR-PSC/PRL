...
# --- Exemple ---
run_path = r'/Users/nathandupuy/Desktop/PSC/PSC_automatisation_du_tracé_des_courbes/runs/model=RBM_alpha=1_hamiltonien=Hypercube_-_L_=_4_-_n_=_2_lr=0.1_n_iters=100_diag_shift=0.05_N_e=300'
ani = animate_spins(run_path, grid_shape=None, fps=10)
